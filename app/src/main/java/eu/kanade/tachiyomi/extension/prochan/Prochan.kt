...
// ✅ الطريقة الجديدة لتغيير اسم ملف الـ APK
tasks.withType<com.android.build.gradle.tasks.PackageApplication>().configureEach {
    val apkName = "Tachiyomi-prochan-${android.defaultConfig.versionName}.apk"
    outputDirectory = outputDirectory.resolveSibling("outputs/apk/${variantName}")
    outputScope.apkDatas.forEach { apkData ->
